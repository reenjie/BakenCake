  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
         <form method="post" enctype="multipart/form-data" action="action_account.php" onsubmit="return false" id="savenew">
          ...
          <input type="hidden" name="savenew">
                ...
                <hr>
                 ...
                 <input type="file" style="font-size: 14px" name="profile" class="form-control e" accept="image/*">
                ...
                <label style="font-size: 14px">Password</label>
                 <input type="text" id="pass" name="password" style="font-size: 14px" class="form-control e" required="">
                
                <button type="button" class="btn btn-dark mt-2" id='generatepass' style="font-size: 13px">Generate a Password</button>
           
           
   
         
        <button type="submit" id="disabledsave" class="btn btn-primary  mt-3"  style="font-size: 15px;float: right;">Save</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
         ...
         <h6>Modify User</h6>
            <label style="font-size: 14px">Email</label>
                 <input type="email" name="eemail" id="eemail" style="font-size: 14px" class="form-control" required="">

                 <label style="font-size: 14px">Lastname</label>
                 <input type="text" name="elastname" id="elastname" style="font-size: 14px" class="form-control" required="">

                  <label style="font-size: 14px">Firstname</label>
                 <input type="text" name="efirstname" id="efirstname" style="font-size: 14px" class="form-control" required="">
              
             
         <input type="hidden" id="catid" name="uid">
        <button type="submit" id="disabledsaved" class="btn btn-light text-dark mt-3"  style="font-size: 15px;float: right;">Modify</button>
...
<div class="modal fade" id="cartlist" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" style="float: right;" aria-label="Close"></button>

        <br>
         <h6 style="font-size: 14px;font-weight: bolder;text-transform: uppercase;" class="text-info" id="usercart"> </h6><i class="fas fa-shopping-cart text-info"></i>
         <hr>
...
<div class="modal fade" id="wishlist" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" style="float: right;" aria-label="Close"></button>
          ...
          <br>
         <h6 style="font-size: 14px;font-weight: bolder;text-transform: uppercase;" class="text-danger" id="usercartw"> </h6> <i class="fas fa-heart text-danger"></i>
         <hr>
...
<div class="modal fade" id="changepp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" style="float: right;" aria-label="Close"></button>
          ...
          <br>
         <form method="post" enctype="multipart/form-data" action="action_account.php" onsubmit="return false" id="changepicture" >
           <input type="hidden" name="changepicture">
        
        <h6 style="font-weight: bolder"> Change Profile Photo </h6>
        <input type="file" id="ppp" name="pp" class="form-control" style="font-size: 14px" accept="image/*" required="">
        <input type="hidden" name="uid" id="userid">
        <button type="submit" class="btn btn-dark form-control mt-2" style="font-size: 14px">Save</button>
         </form>  
    </div>
  </div>
</div>
