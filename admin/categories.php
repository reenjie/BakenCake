        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="font-size: 14px" >
          ...
          <div class="sidebar-heading text-secondary" style="font-size: 12px">
            ...
            <li class="nav-item navitems">
              ...
              <li class="nav-item navitems">
                <a class="nav-link navlinks  " href="categories.php">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="cat" id="newcat" style="font-size: 14px" name="" class="form-control mb-2" required="">
         <div id="msg"></div> 
         
        <button type="submit" id="disabledsave" class="btn btn-light text-dark" disabled="" style="font-size: 15px;float: right;">Save</button>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="cat" id="editcat" style="font-size: 14px" name="" class="form-control mb-2" required="">
         <div id="msgedit"></div> 
         <input type="hidden" id="catid" name="catid">
        <button type="submit" id="disabledsaved" class="btn btn-light text-dark" disabled="" style="font-size: 15px;float: right;">Modify</button>
