...
<div class="modal fade" id="addmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
         <form method="post" action="action_product.php" onsubmit="return false" id="savenew" enctype="multipart/form-data">
          ...
          <div class="container">
             <div class="row">
              <div class="col-md-4">
                ...
                <input type="file" name="image[]" onchange="javascript:updateList()" id="file" style="font-size: 14px" class="form-control" accept="image/*" multiple="">
                <span style="font-size: 14px" id="imgsa"> Max of 3 Images will be accepted <span class="text-danger">*</span></span>
                <hr>
                 <style type="text/css">
  ...
  width: 2px;
                ...
                <h6 style="font-size: 14px">Selected Photos</h6>
                         ...
                         <div id="fileList" style="height: 240px;overflow-y: scroll;border-bottom:1px solid #b2c1c2;border-top:1px solid #b2c1c2"></div>
              ...
              <input type="text" name="name"  style="font-size: 14px" class="form-control mb-2" required="">
              ...
              <input type="text" name="price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  style="font-size: 14px" class="form-control mb-2" required="">
        ...
        <button type="submit" id="disabledsave" class="btn btn-light text-dark" style="font-size: 15px;float: right;">Save</button>
      ...
      <div class="modal-body">
        ...
        <div class="container">
            ...
            <h6>Modify Product</h6>
               ...
               <label style="font-size: 14px" class="mb-3 mt-5">Enter Product Name : </label>
              <input type="text" name="ename" id="ename"  style="font-size: 14px" class="form-control mb-2" required="">
              <label style="font-size: 14px" class="mb-3">Select Category: </label>
              ...
              <select class="form-select mb-2" id="categoryid" name="ecat" style="font-size: 14px">
                ...
                <label style="font-size: 14px" class="mb-3">Enter Price: </label>
              <input type="text" name="eprice" id="eprice" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  style="font-size: 14px" class="form-control mb-2" required="">
                  <label style="font-size: 14px" class="mb-3">Enter Description: </label>
                  <textarea style="font-size: 14px" name="edesc" id="edesc" class="form-control"></textarea>
                <input type="hidden" name="eid" id="eid">
               
          </div> 
        <button type="submit"  class="btn btn-light text-dark mt-3"  style="font-size: 15px;float: right;">Modify</button>
...
<?php 
  if(isset($_GET['viewproducts'])){
    ...
    <button type="button" class="btn btn-primary d-none" id="openview" data-bs-toggle="modal" data-bs-target="#itemsview" data-bs-target="#staticBackdrop">
  ...
  <div class="modal-dialog  modal-lg ">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <button type="button" onclick="window.location.href='products.php'" style="float: right;" class="btn-close mb-2" data-bs-dismiss="modal" aria-label="Close"></button>
...
<button type="button" class="btn btn-dark" style="font-size: 14px" data-bs-toggle="modal"  data-bs-target="#exampleModal">
       ...
       <?php 
           $tochangep = " select * from photo where prod_id ='$id'   ";
                    ...
                    ?>
                     ...
                     <div class="card mb-2">
                        <div class="card-body">
                           <form method="post" enctype="multipart/form-data" action="action_product.php" onsubmit="return false" id="updatephoto" >
                          ...
                          <img src="<?php echo $src ?>" style="width: 100%; height: 300px;">
                            ...
                            <input type="file" name="imagee" class="form-control" accept="image/*" required="">

                            <button type="submit" class="btn btn-dark mt-3" style="font-size: 14px"> Save Changes</button>
                            ...
                            <script type="text/javascript">
                             ...
                             <div class="container">
                              ...
                              <h6>Save a photo for this Product</h6>
                               <form method="post" action="action_product.php" enctype="multipart/form-data" onsubmit="return false" id="addphotos">
                                 <input type="hidden" name="addphotos">
                              
                                 <label style="font-size: 14px" class="mb-3">Multiple Photo Selection </label>
                <input type="file" name="image[]" onchange="javascript:updateList()" id="filess" style="font-size: 14px" class="form-control" accept="image/*" multiple="" required="">
                <span style="font-size: 14px" id="imgsad"> Max of 3 Images will only be accepted <span class="text-danger">*</span></span>
                <br>
                <input type="hidden" value="<?php echo $id ?>" name="prod">


                  <button class="btn btn-dark mt-4" style="font-size: 14px;float: right;"> Save Photos</button>
                                 </form>  
...
<!-- Modal -->
  ...
  for (var i = 0; i < input.files.length; ++i) {
    output.innerHTML += '<div class="card mb-1 " style="border-left:4px solid #5a7c7d"><div class="card-body">' + input.files.item(i).name + '</div></div>';
  }
