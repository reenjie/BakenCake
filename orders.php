...
#item::-webkit-scrollbar-thumb:hover {
                               ...
                               <span style="font-size: 13px;float: right;">[See status]</span>
                                    ...
                                    ?>
                                     <div class="container mt-5">
                                        <h6 style="text-align: center;" class="text-secondary">You dont have any orders yet.</h6>
                                     </div> 
                              ...
                              <h4 style="text-align: center;" class="text-success"> 
                                ...
                                if($row['status'] == 'pending'){
                                  ...
                                  echo '<span class="text-info" style="font-weight:bolder">ON THE WAY</span>';
                                    ?>
                                    <br>
                                    <button  class="btn btn-success mt-5 btnreceive" data-pm="<?php echo $row['paymentmethod'] ?>" data-od="<?php echo $tid ?>" style="font-size: 14px">RECEIVE</button>
                                    <br>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
                              ...
                              ?>
                               <div class="container">
                                   <div style="text-align: center;">
                                    <img src="img/undraw_starry_window_re_0v82.svg" class="img-fluid mt-4" style="width: 150px">
             ...
             $("#myorders").css({'height':($("#allorders").height()+'px')});
...
<button type="button" class="btn btn-primary d-none" id="modalrate" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <button type="button" style="float: right;" class="btn-close" id="cc" data-bs-dismiss="modal" aria-label="Close"></button>

          <div class="container mt-5">

            <h5 class="text-success" style="text-align: center;font-weight: bolder;">You have confirmed that you have received your order. <br>
             ...
             <h6 style="text-align: center;" class="mt-3 mb-3 ">
                  We are pleased to have your rating about our shop! Thank you for ordering and trusting our service.
               </h6>
               ...
               <textarea class="form-control mt-2" rows="10" placeholder="Leave us a comment.."></textarea>
    ...
    $('#cc').click(function() { 
     ...
     $( ".rate" ).hover(function() {
                    ...
                    //  $('#rate'+i).css('font-size','26px');
                       $('#rate'+i).removeClass('far fa-star').addClass('fas fa-star').addClass('text-warning');
                      }
                      ...
                      //$('#rate'+i).css('font-size','20px');
                       $('#rate'+i).removeClass('fas fa-star').addClass('far fa-star').removeClass('text-warning');
                      }
