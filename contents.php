    ...
    <span class="visually-hidden">Next</span>
              ...
              <br>
                     <?php 
                        if(isset($cart)){
                          ...
                          ?>
                         <button class="btn btn-light text-info addcarts" style="font-size: 13px;font-weight: bold" data-productid="<?php echo $id ?>">  Add to Cart <i class="fas fa-cart-plus"></i></button>
           ...
           /*   $user = $_SESSION['user_id'];
                  ...
                  $checkifonthelist = " select * from wishlist where prod_id ='$id' and user_id = '$user'  ";
                           ...
                           if ($thecountings>=1){
                           ?>
                            <button class="btn btn-light text-danger removewlist"   data-productid="<?php echo $id ?>" style="font-size: 13px;font-weight: bold"><i class="fas fa-heart"></i></button>
                           <?php
                        }else {
                        ?>
                           <button class="btn btn-light text-danger addwishlist"   data-productid="<?php echo $id ?>" style="font-size: 13px;font-weight: bold"><i class="far fa-heart"></i></button>
                        <?php
                        }
              */
               ?>
  ...
  <div class="carousel-inner">
   <?php 
      ...
      $gtproductphotosactive = " select * from photo where prod_id = '$product_id' limit 1  ";
         ...
         <div class="carousel-item active">
      <img src="<?php echo $src ?>" class="d-block w-100" alt="..." style="width: 100px;height: 250px;">
    </div>
    ...
    ?>
                                  ...
                                  <div class="col-sm-8">
                                     ...
                                     <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal" data-backdrop="static" data-keyboard="false" style="text-decoration: none"> <h5 style="font-weight: bolder;"><?php echo $item['name'] ?></h5></a>
                ...
                <div class="det" style="font-size: 14px;height: 80px;overflow-y: scroll;">
                  <?php echo $item['description'] ?>
                   ...
                   <button class="btn btn-light text-info addcart" style="font-size: 13px;font-weight: bold;float: right;" data-productid="<?php echo $item['prod_id']?>">  Add to Cart <i class="fas fa-cart-plus"></i></button>
                 
                         <button class="btn btn-light text-danger removefromlist " data-productid="<?php echo $item['prod_id']?>" style="font-size: 13px;font-weight: bold;float: right; margin-right: 5px;" data-productid="<?php echo $item['prod_id']?>"> Remove <i class="fas fa-times"></i></button>
                                  </div> 
